...
@Component({
  selector: 'app-mnm-loading-screen',
  templateUrl: './mnm-loading-screen.component.html',
  styleUrls: ['./mnm-loading-screen.component.css']
})
export class MnmLoadingScreenComponent implements OnInit {
    ...
    if (this.CreateIndentLineItem.invalid || this.SourceForm.invalid || this.milkChallanForm.invalid || this.toDestinationForm.invalid || this.loadingForm.invalid || this.routDetailForm.invalid || customerFormValid) {
      ...
      this.CreateIndentLineItem.controls.newIndtLItem.value.forEach(e => {
        this.itemArray.push({
          ...
          // "srcTareWt": 12000.0,
          // "srcGrossWt": 12002.0,
          "loadedQty": e.quantity,
          "loadedFat": e.fat,
          "loadedSNF": e.snf,
          "loadedCLR": e.clr,
          "loadedAcidity": e.acidity,
          "loadTimeTemp": e.temp,
