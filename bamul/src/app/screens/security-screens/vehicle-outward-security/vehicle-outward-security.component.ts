...
@Component({
  selector: 'app-vehicle-outward-security',
  templateUrl: './vehicle-outward-security.component.html',
  styleUrls: ['./vehicle-outward-security.component.css']
})
export class VehicleOutwardSecurityComponent implements OnInit {
  rowData: any;
  modalRef: BsModalRef;
  routeDetail: any = [];
  userData: any;
  ...
  getAllTransferRoutesOnLoad(){
    ...
    if(this.userData.locationName){
      ...
      this.securityService.getAllTransferRoutesOut(this.userData.locationName,currentDate).subscribe(res => {
