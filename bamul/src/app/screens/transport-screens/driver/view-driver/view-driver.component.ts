...
export class ViewDriverComponent implements OnInit {
  ...
  datePickerConfig: Partial<BsDatepickerConfig>;
    ...
    viewDoc(){
      this.router.navigateByUrl('super-admin/transport/driver/list-drivers');
    }
    setDriverRecord() {
        this.driverData = JSON.parse(localStorage.getItem('driverList'));
        if (this.driverData) {
            ...
            this.Driver.patchValue({
                ...
                recordCreationDate: this.driverData.recordCreationDate,
                recordCreationBy: this.driverData.recordCreationBy,

            })
            if (this.driverData.driverAssignmentsList[0]) {
              this.DriverAssignments.disable();
                this.DriverAssignments.patchValue({
                    assignmentId: this.driverData.driverAssignmentsList[0].assignmentId,
                    vendorId: this.driverData.driverAssignmentsList[0].vendorId,
                    department: this.driverData.driverAssignmentsList[0].department,
                    startDate: this.driverData.driverAssignmentsList[0].startDate,
                    endDate: this.driverData.driverAssignmentsList[0].endDate,
                    recordCreationDate: this.driverData.driverAssignmentsList[0].recordCreationDate,
                    recordCreationBy: this.driverData.driverAssignmentsList[0].recordCreationBy,
                    driver:
                    {
                        driverId: this.driverData.driverId
                    }
        ...
        this.driverService.byrefidandreference(this.driverData.driverId).subscribe(res => {
            ...
            if (this.documentsList.length > 0) {
                ...
                for (let index = 0; index < this.documentsList.length; index++) {
                    ...
                    (<FormGroup>this.Driverdocuments.controls.users).controls[index].patchValue({ "createdBy": this.documentsList[index].creationBy });
                }
            }
        })
    }
