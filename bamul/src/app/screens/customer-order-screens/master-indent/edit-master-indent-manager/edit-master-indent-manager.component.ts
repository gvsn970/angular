...
@Component({
  selector: 'app-edit-master-indent-manager',
  templateUrl: './edit-master-indent-manager.component.html',
  styleUrls: ['./edit-master-indent-manager.component.css']
})
export class EditMasterIndentManagerComponent implements OnInit {
  selectLabel: any;
  modalRef: BsModalRef;
  addMore = true;
  message: string;
  ...
  constructor(
    ...
    this.masterIndentUp =  JSON.parse(localStorage.getItem('manager-edit-master-indent'));
